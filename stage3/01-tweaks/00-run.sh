...
# install videowall
install -m 777 -g pi -o pi ${VIDEOWALL_APPIMAGE}  ${ROOTFS_DIR}/home/pi/
install -m 777 -g pi -o pi files/run-videowall.sh ${ROOTFS_DIR}/home/pi/

# install autostart
install -v -d -g pi -o pi             ${ROOTFS_DIR}/home/pi/.config/lxsession/LXDE-pi
install -v -m 644 files/autostart -g pi -o pi ${ROOTFS_DIR}/home/pi/.config/lxsession/LXDE-pi/autostart
